# Snakemake workflow: rna-seq-slamseq
...
1. Once, register the upstream repository in your local copy: `git remote add -f upstream git@github.com:snakemake-workflows/rna-seq-slamseq.git` or `git remote add -f upstream https://github.com/snakemake-workflows/rna-seq-slamseq.git` if you do not have setup ssh keys.
